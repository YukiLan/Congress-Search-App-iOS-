//
//  FavCommiTableViewController.swift
//  hw9
//
...
class FavCommiTableViewController: UITableViewController,UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.favList += CommiHouseDetailViewController.favList
        self.favList += CommiSenateDetailViewController.favList
        self.favList += CommiJointDetailViewController.favList
 ...
 */
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        var viewcontroller = storyboard.instantiateViewController(withIdentifier: "FavCommiDetailViewController") as! FavCommiDetailViewController
