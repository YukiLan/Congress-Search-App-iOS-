...
import SwiftyJSON
import SwiftSpinner
class HouseCommitteeViewController: UITableViewController,UISearchBarDelegate{
    ...
    let url = URL(string: "http://lowcost-env.hpxtbwf8zn.us-west-2.elasticbeanstalk.com/?action=committee")!
...
*/
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        var viewcontroller = storyboard.instantiateViewController(withIdentifier: "CommiHouseDetailViewController") as! CommiHouseDetailViewController
