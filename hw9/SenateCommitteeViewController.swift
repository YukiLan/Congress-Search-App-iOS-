...
import SwiftyJSON
import SwiftSpinner
class SenateCommitteeViewController: UITableViewController,UISearchBarDelegate {
 ...
 */
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        var viewcontroller = storyboard.instantiateViewController(withIdentifier: "CommiSenateDetailViewController") as! CommiSenateDetailViewController
